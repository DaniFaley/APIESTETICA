...
const usuarioServices = __importStar(require("../../services/Usuario/usuarioServices"));
//Activamos las rutas
...
router.get('/', (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let usuario = yield usuarioServices.obtieneUsuario();
    res.send(usuario);
}));
//Para mostrar un registro en especifico
//http://localhost:3001/api/usuario/1 <------Numero id del personal
router.get('/:id_datos_usuario', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let usuario = yield usuarioServices.encuentraUsuario(Number(req.params.id_datos_usuario));
    res.send(usuario);
}));
//Para insertar
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const nuevo = yield usuarioServices.agregarUsuario({
            primer_nombre,
            segundo_nombre,
            primer_apellido,
            segundo_apellido,
...
router.put('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const modificado = yield usuarioServices.modificarUsuario({
            id_datos_usuario,
            primer_nombre,
            segundo_nombre,
            primer_apellido,
...
router.delete('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const eliminado = yield usuarioServices.borrarUsuario(Number(id_datos_usuario));
        res.send(eliminado);
    }
    catch (e) {
        res.status(400).send("Error en los datos");
