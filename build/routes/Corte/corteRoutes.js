...
const corteServices = __importStar(require("../../services/Corte/corteServices"));
//Activamos las rutas
...
router.get('/', (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let corte = yield corteServices.obtieneCorte();
    res.send(corte);
}));
//Para mostrar un registro en especifico
//http://localhost:3001/api/corte/1 <------Numero id del personal
router.get('/:id_corte', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let corte = yield corteServices.encuentraCorte(Number(req.params.id_corte));
    res.send(corte);
}));
//Para insertar
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const nuevo = yield corteServices.agregarCorte({
            nombre_cliente,
            fk_id_sexo,
            fk_id_servicio,
            monto,
...
router.put('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const modificado = yield corteServices.modificarCorte({
            id_corte,
            nombre_cliente,
            fk_id_sexo,
            fk_id_servicio,
...
router.delete('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const eliminado = yield corteServices.borrarCorte(Number(id_corte));
        res.send(eliminado);
    }
    catch (e) {
        res.status(400).send("Error en los datos");
