...
const rol_usuarioServices = __importStar(require("../../services/RolUsuario/rol_usuarioServices"));
//Activamos las rutas
...
router.get('/', (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let rol_usuario = yield rol_usuarioServices.obtieneRolUsuario();
...
router.get('/:id_usuario', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let rol_usuario = yield rol_usuarioServices.encuentraRolUsuario(Number(req.params.id_usuario));
    res.send(rol_usuario);
}));
//Para insertar
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const nuevo = yield rol_usuarioServices.agregarRolUsuario({
            correo,
            contrasena,
            fk_id_rol
        });
...
router.put('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const modificado = yield rol_usuarioServices.modificarRolUsuario({
            id_usuario,
            correo,
            contrasena,
            fk_id_rol
...
router.delete('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const eliminado = yield rol_usuarioServices.borrarRolUsuario(Number(id_usuario));
        res.send(eliminado);
    }
    catch (e) {
        res.status(400).send("Error en los datos");
